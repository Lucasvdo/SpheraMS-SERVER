...
function getJobTierScrolls() {
    ...
    const GameConstants = Java.type('br.com.spherams.constants.game.GameConstants');
...
function getScrollSuccessTier(scrollStats) {
    ...
    const YamlConfig = Java.type('br.com.spherams.config.YamlConfig');
    if (prop > 90) {
        return 3;
    } else if (prop < 50) {
...
function getAvailableScrollsPool(baseScrolls, rewardTier, successTier) {
    var scrolls = [];
    const ItemInformationProvider = Java.type('br.com.spherams.server.ItemInformationProvider');
...
function calculateMobBookBuckets() {
    ...
    const MonsterBook = Java.type('br.com.spherams.client.MonsterBook');
...
function generateRandomScroll() {
    const InventoryType = Java.type('br.com.spherams.client.inventory.InventoryType');
