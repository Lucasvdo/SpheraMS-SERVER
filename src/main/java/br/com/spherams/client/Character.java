 ...
 */
package br.com.spherams.client;

import br.com.spherams.client.autoban.AutobanManager;
import br.com.spherams.client.creator.CharacterFactoryRecipe;
import br.com.spherams.client.inventory.*;
import br.com.spherams.client.inventory.Equip.StatUpgrade;
import br.com.spherams.client.inventory.manipulator.CashIdGenerator;
import br.com.spherams.client.inventory.manipulator.InventoryManipulator;
import br.com.spherams.client.keybind.KeyBinding;
import br.com.spherams.client.keybind.QuickslotBinding;
import br.com.spherams.client.newyear.NewYearCardRecord;
import br.com.spherams.client.processor.action.PetAutopotProcessor;
import br.com.spherams.client.processor.npc.FredrickProcessor;
import br.com.spherams.config.YamlConfig;
import br.com.spherams.constants.game.ExpTable;
...
import br.com.spherams.constants.skills.*;
import br.com.spherams.net.packet.Packet;
import br.com.spherams.net.server.PlayerBuffValueHolder;
import br.com.spherams.net.server.PlayerCoolDownValueHolder;
import br.com.spherams.net.server.Server;
import br.com.spherams.net.server.coordinator.world.InviteCoordinator;
import br.com.spherams.net.server.guild.Alliance;
import br.com.spherams.net.server.guild.Guild;
import br.com.spherams.net.server.guild.GuildCharacter;
import br.com.spherams.net.server.guild.GuildPackets;
import br.com.spherams.net.server.services.task.world.CharacterSaveService;
import br.com.spherams.net.server.services.type.WorldServices;
import br.com.spherams.net.server.world.*;
import br.com.spherams.scripting.AbstractPlayerInteraction;
import br.com.spherams.scripting.event.EventInstanceManager;
import br.com.spherams.scripting.item.ItemScriptManager;
import br.com.spherams.server.*;
import br.com.spherams.server.ExpLogger.ExpLogRecord;
import br.com.spherams.server.ItemInformationProvider.ScriptedItem;
import br.com.spherams.server.events.Events;
import br.com.spherams.server.events.RescueGaga;
import br.com.spherams.server.events.gm.Fitness;
import br.com.spherams.server.events.gm.Ola;
import br.com.spherams.server.life.*;
import br.com.spherams.server.maps.*;
import br.com.spherams.server.maps.MiniGame.MiniGameResult;
import br.com.spherams.server.minigame.RockPaperScissor;
import br.com.spherams.server.partyquest.AriantColiseum;
import br.com.spherams.server.partyquest.MonsterCarnival;
import br.com.spherams.server.partyquest.MonsterCarnivalParty;
import br.com.spherams.server.partyquest.PartyQuest;
import br.com.spherams.server.quest.Quest;
import br.com.spherams.tools.*;
import br.com.spherams.tools.packets.WeddingPackets;
...
public class Character extends AbstractCharacterObject {
    ...
    public void sendPolice(int greason, String reason, int duration) {
        sendPacket(PacketCreator.sendPolice(String.format("You have been blocked by the#b %s Police for %s.#k", "SpheraMS", reason)));
        this.isbanned = true;
    ...
    public void autoban(String reason) {
        ...
        this.ban(reason);
        sendPacket(PacketCreator.sendPolice(String.format("You have been blocked by the#b %s Police for HACK reason.#k", "SpheraMS")));
        TimerManager.getInstance().schedule(new Runnable() {
            @Override
            public void run() {
                client.disconnect(false, false);
